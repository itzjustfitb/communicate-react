...
<div className="requestsections">

<div className="desireiconcontainer">

<div className="desiretext">
Öz istəyinə görə seç
</div>
...
<div className="colchild4">
      <label htmlFor="item4">
        <svg
          xmlns="https://www.freepik.com/premium-vector/tiger-paw-grunge-style-vector_23228514.htm#fromView=search&page=1&position=34&uuid=de5fb513-0411-4d16-94d6-a2e15c2bd627"
          width="24"
          height="24"
          viewBox="0 0 24 24"
...
<div class="checkbox-container">
  ...
  <label className="labeltext" for="myCheckbox2">
...
<div class="checkbox-container">
  ...
  <label className="labeltext" for="myCheckbox3">
...
<div class="checkbox-container">
  ...
  <label className="labeltext" for="myCheckbox4">
