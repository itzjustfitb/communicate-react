          ...
          <div className="reuqstcenters">
            <div className="colchildsall">
              <div className="colchild4">
                ...
                />
                <br />
                <span id="item1Counter">
                  Siz {forvalue} seçim etdiniz və xidmət haqqı :
                </span>
                <span id="item1Span">
                  {forvalue * (clicksfor === 0 ? 50 : -50)}Azn
                </span>
              </div>
              ...
              <div className="colchild2">
                ...
                <span className="valuescounter" id="item1Counter">
                  Siz {twovalue} seçim etdiniz və xidmət haqqı :
                </span>
                <span id="item1Span">
                  {twovalue * (clicks === 0 ? 15 : -15)}Azn
                </span>
              </div>
              ...
              <div className="colchild1">
                ...
                <span id="item1Span">
                  {value * (clickCount === 0 ? 150 : -150)}Azn
                </span>
              </div>
              ...
              <div className="colchild3">
                ...
                <br />
                <span id="item1Counter">
                  Siz {threvalue} seçim etdiniz və xidmət haqqı :
                </span>
                <span id="item1Span">
                  {threvalue * (clicksthree === 0 ? 15 : -15)}Azn
                </span>
              </div>
            ...
            <div className="chechkboxalls">
              <div class="checkbox-container">
                ...
                <div class="message">
                  ...
                  unde itaque eaque excepturi, consequuntur repudiandae delectus
                  tempora laudantium blanditiis ex deserunt necessitatibus ipsum
                  vero culpa? Quasi est doloribus non impedit.
                </div>
              </div>
